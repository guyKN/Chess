...
//todo: implement
    ...
    constexpr inline bool squareMask_ok(SquareMask squareMask) {
    ...
    constexpr inline bool notSquareMask_ok(NotSquareMask notSquareMask) {
    ...
    enum Piece : int {
        ...
        PIECE_LAST_WHITE = PIECE_WHITE_PAWN,
        PIECE_FIRST_BLACK = PIECE_BLACK_PAWN,
        PIECE_LAST_BLACK = PIECE_BLACK_PAWN,
        PIECE_INVALID = -1
    };
    ...
    constexpr inline char toChar(Piece piece) {
        switch (piece) {
            ...
            case PIECE_NONE:
                return ' ';
            default:
                assert(false); // piece must be a valid value
                return '.';
        }
    }
    ...
    constexpr Piece STARTING_BOARD[NUM_SQUARES] = {PIECE_NONE, PIECE_NONE, PIECE_NONE, PIECE_NONE, PIECE_NONE,
                                                   PIECE_NONE,
                                                   PIECE_NONE, PIECE_NONE,
                                                   PIECE_WHITE_PAWN, PIECE_WHITE_PAWN, PIECE_WHITE_PAWN,
                                                   PIECE_WHITE_PAWN,
                                                   PIECE_WHITE_PAWN, PIECE_WHITE_PAWN, PIECE_WHITE_PAWN,
                                                   PIECE_WHITE_PAWN,
                                                   ...
                                                   PIECE_NONE,
                                                   PIECE_NONE, PIECE_NONE,
                                                   PIECE_BLACK_PAWN, PIECE_BLACK_PAWN, PIECE_BLACK_PAWN,
                                                   PIECE_BLACK_PAWN,
                                                   PIECE_BLACK_PAWN, PIECE_BLACK_PAWN, PIECE_BLACK_PAWN,
                                                   PIECE_BLACK_PAWN,
                                                   PIECE_NONE, PIECE_NONE, PIECE_NONE, PIECE_NONE, PIECE_NONE,
